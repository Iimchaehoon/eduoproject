...
export default function Course(){
  ...
  const send = () => {
    ...
    setMsgs(m => [...m, userMsg, botMsg]); setInput('')
  }
  return (
    <div className="max-w-6xl mx-auto px-5 py-8 grid md:grid-cols-[1fr_360px] gap-6">
      <section className="card p-0 overflow-hidden">
        ...
        <div className="bg-slate-900 h-[380px] flex items-center justify-center"><button className="w-20 h-20 rounded-full bg-primary text-white text-2xl shadow-soft">▶</button></div>
        <div className="p-5">
...
print(student1.study())</pre>
      ...
      <aside className="card p-0 overflow-hidden">
        ...
        <div className="border-t border-skin-ring p-3 flex items-center gap-2">
          <input className="flex-1 pill" placeholder="궁금한 점을 물어보세요..." value={input} onChange={e=>setInput(e.target.value)}/>
